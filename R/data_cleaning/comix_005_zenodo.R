...
write.csv(CoMix_ch_contact_extra,"./data/processed/zenodo/CoMix_ch_contact_extra.csv")


#CoMix_ch_hh_common.csv
CoMix_ch_hh_common <- CoMix_ch_contact_common[,c("cont_id","part_id","cnt_relationship")]
CoMix_ch_hh_common1 <- part[,c("part_id","household_size")]
CoMix_ch_hh_common <- merge(CoMix_ch_hh_common, CoMix_ch_hh_common1, by="part_id", all.x =TRUE)
remove(CoMix_ch_hh_common1)
CoMix_ch_hh_common$hh_id <- CoMix_ch_hh_common$cont_id
...
CoMix_ch_hh_common <- CoMix_ch_hh_common[,c("part_id", "hh_id", "household_size", "cnt_relationship", "country")]
write.csv(CoMix_ch_hh_common,"./data/processed/zenodo/CoMix_ch_hh_common.csv")
...
write.csv(CoMix_ch_contact_common,"./data/processed/zenodo/CoMix_ch_contact_common.csv")
...
write.csv(CoMix_ch_participant_common,"./data/processed/zenodo/CoMix_ch_participant_common.csv")
...
write.csv(CoMix_ch_participant_extra,"./data/processed/zenodo/CoMix_ch_participant_extra.csv")
...
write.csv(CoMix_ch_sday,"./data/processed/zenodo/CoMix_ch_sday.csv")
